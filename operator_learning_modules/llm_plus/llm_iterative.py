...
class BaseLLMIterativeOperatorLearningModule:
    ...
    """
    def __init__(self, learned_operators, domain_name, llm, llm_precondition_goal_ops, planning_ops, log_llm:bool):
...
class LLMZPKIterativeOperatorLearningModule(BaseLLMIterativeOperatorLearningModule):
    def __init__(self, learned_operators, domain_name, llm, llm_precondition_goal_ops, planning_ops, log_llm):
        self.learner = ZPKOperatorLearningModule(learned_operators, domain_name, planning_ops)
        self._ndrs = self.learner._ndrs

        super().__init__(learned_operators, domain_name, llm, llm_precondition_goal_ops, planning_ops, log_llm)
