...
class Planner:
    ...
    def _create_domain_file_predicates(self):
        ...
        name_less_than_egg = f'\t\t(name-less-than ?arg0 - egg_hypothetical ?arg1 - egg_hypothetical)'
        if name_less_than_egg not in preds_pddl:
            preds_pddl.append(name_less_than_egg)
